  ...
  return (
    <main>
      ...
      <footer className='absolute lg:left-162 lg:bottom-10 bottom-2'>
          ...
          <a href="/xyz"><span className="material-symbols-outlined"><p className='text-5xl lg:m-4 lg:mb-0 m-2'>forum</p></span></a>
