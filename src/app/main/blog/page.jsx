...
const page = () => {
  return (
    <div className='lg:overflow-hidden'>
      ...
      <a href="/">
      <span class="material-symbols-outlined"><p className='text-4xl absolute lg:bottom-4 right-44 lg:right-8 lg:h-12 lg:w-12 lg:pl-1 lg:rounded-3xl lg:text-black lg:bg-white'>home</p></span>
      </a>
    </div>
  )
}
