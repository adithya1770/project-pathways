...
const Page = () => {
  ...
  return (
    <div className="flex flex-wrap justify-center">
      ...
      {repos.map((repo) => (
        <div key={repo.id} className='ibm-plex-mono-medium lg:h-72 lg:w-110 grad lg:ml-10 h-52 w-96 bg-white m-4 rounded-xl shadow-md hover:border-cyan-400'>
      ...
      <a href="/">
      <span className="material-symbols-outlined"><p className='text-4xl absolute lg:bottom-4 right-40 lg:right-8 lg:h-12 lg:w-12 lg:pl-1 bottom-2 lg:rounded-3xl lg:text-black lg:bg-white'>home</p></span>
      </a>
    </div>
  );
};
